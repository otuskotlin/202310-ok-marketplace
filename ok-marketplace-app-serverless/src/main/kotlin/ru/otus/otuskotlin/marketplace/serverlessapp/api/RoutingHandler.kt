...
import ru.otus.otuskotlin.marketplace.serverlessapp.api.v1.IV1HandleStrategy
import ru.otus.otuskotlin.marketplace.serverlessapp.api.v1.v1handlers
import ru.otus.otuskotlin.marketplace.serverlessapp.api.v2.IV2HandleStrategy
    ...
    override fun handle(event: Request, context: Context): Response =
        try {
            ...
            when {
                ...
                url.isVersion(IV1HandleStrategy.VERSION) -> v1handlers(event, context)
                url.isVersion(IV2HandleStrategy.VERSION) -> v2handlers(event, context)
